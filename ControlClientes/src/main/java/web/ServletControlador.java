...
public class ServletControlador extends HttpServlet {
    ...
    //accionDefault: Método que usa tanto el doGet como el doPost
    private void accionDefault(HttpServletRequest request, HttpServletResponse response)
        ...
        //request.getRequestDispatcher("clientes.jsp").forward(request, response);//Este codigo deja contenido en la URL. Se pone el de abajo mejor
